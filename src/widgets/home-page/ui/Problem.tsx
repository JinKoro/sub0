...
const ITEMS = [
  ...
  },
  {
    ...
    en: 'No single list',
    subRu: 'Подписки — в почте, в банке, в блокноте. Не видишь общей картины.',
  ...
  },
  {
    ...
    subRu: 'Списали в день зарплаты? Или до. Никто не предупредил.',
    subEn: 'Charged on payday? Or before it? No one warned you.',
    metric: '3000 ₽',
    metricRu: 'теряется в мес',
...
export function Problem() {
  ...
  return (
    <Section bg={SUB0.bg} pad="120px 48px 100px">
      <SectionEyebrow num="03">{t('Проблема', 'The problem')}</SectionEyebrow>
      <h2 style={{ fontSize: 48, fontWeight: 700, lineHeight: 1.05, letterSpacing: '-0.03em', margin: '0 0 56px', maxWidth: 820 }}>
        {t('Подписки разбросаны —', 'Subscriptions are scattered —')}{' '}
        <span style={{ color: SUB0.blue }}>{t('деньги утекают.', 'money leaks out.')}</span>
      </h2>

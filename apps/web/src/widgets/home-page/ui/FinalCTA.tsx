  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', textAlign: 'center', position: 'relative' }}>
        ...
        <h2 style={{
          fontSize: isMobile ? 40 : 72, fontWeight: 700, lineHeight: 1.03,
        ...
        <p style={{
          fontSize: isMobile ? 16 : 18, color: '#bfbfb8',
          maxWidth: 620, margin: '0 auto 40px', lineHeight: 1.5,
        }}>
          {t(
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="#" className="s-btn" style={{
            ...
            background: SUB0.blue, color: '#fff', borderRadius: 10,
            fontWeight: 600, fontSize: isMobile ? 15 : 17, textDecoration: 'none',
            flex: isMobile ? '1 1 auto' : 'unset', justifyContent: 'center',
          }}>
          ...
          <a href="#" className="s-btn" style={{
            ...
            background: 'transparent', color: SUB0.bg,
            border: '1px solid #2a2a2a', borderRadius: 10,
            fontWeight: 500, fontSize: isMobile ? 15 : 17, textDecoration: 'none',
            flex: isMobile ? '1 1 auto' : 'unset', justifyContent: 'center',
          }}>
        ...
        <div style={{
          marginTop: 32, display: 'flex', gap: 20, justifyContent: 'center',
          flexWrap: 'wrap', fontFamily: mono, fontSize: 13, color: '#999',
        }}>

...
export function Hero() {
  ...
  return (
    <section id="top" style={{
      ...
      background: SUB0.bg, position: 'relative', overflow: 'hidden',
    }}>
      ...
      <div style={{
        ...
        <div style={{ paddingTop: isMobile ? 0 : 28 }}>
          <div style={{
            ...
            <span style={{ width: 6, height: 6, borderRadius: 999, background: SUB0.blue, animation: 's-pulse 1.6s infinite', flexShrink: 0 }} />
          ...
          <h1 style={{
            fontSize: isMobile ? 44 : 68, fontWeight: 700, lineHeight: 1.01,
          ...
          <p style={{ fontSize: isMobile ? 16 : 19, lineHeight: 1.55, color: SUB0.ink, maxWidth: 540, margin: '0 0 36px' }}>
            {t(
          ...
          <div style={{
            ...
            <a href="#" className="s-btn" style={{
              ...
              background: SUB0.ink, color: SUB0.bg, borderRadius: 10,
              fontWeight: 600, fontSize: isMobile ? 15 : 16, textDecoration: 'none',
            ...
            <a href="#dashboard" className="s-btn" style={{
              ...
              background: 'transparent', color: SUB0.ink,
              border: `1px solid ${SUB0.line}`, borderRadius: 10,
              fontWeight: 500, fontSize: isMobile ? 15 : 16, textDecoration: 'none',
              width: isMobile ? '100%' : 'auto',
            }}>
          ...
          <div style={{
            display: 'flex', gap: 16, fontSize: 13, color: SUB0.muted,
            fontFamily: mono, marginBottom: 36, flexWrap: 'wrap',
          }}>
          ...
          <div style={{
            ...
            {importChips.map(([k, title, sub, soon]) => (
              <div key={k} style={{
                ...
                padding: '10px 14px', background: SUB0.panel,
                border: `1px solid ${SUB0.line}`, borderRadius: 10,
              ...
              {SUBS.map((r, i) => {
                ...
                return (
                  <div key={r.name} style={{
                    ...
                    padding: '9px 0', borderBottom: `1px dashed ${SUB0.line}`,
                    fontSize: 14,
                    opacity: shown ? 1 : 0,
                    transform: shown ? 'translateY(0)' : 'translateY(6px)',
                    transition: 'opacity .35s ease, transform .35s ease',
                    ...
                    <span style={{ fontFamily: mono, fontWeight: 600 }}>{fmtRub(r.price, { short: true })}</span>
                  </div>
                )
              })}
              <div style={{
                ...
                <span style={{ fontSize: 12, color: SUB0.muted, fontFamily: mono }}>{t('Итого в месяц', 'Monthly total')}</span>
                <span style={{ fontSize: 20, fontWeight: 700, color: SUB0.blue }}>{fmtRub(monthlyTotal, { short: true })}</span>
              </div>
            </div>
          </div>
        )}

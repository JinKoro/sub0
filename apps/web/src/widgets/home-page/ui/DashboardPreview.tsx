        ...
        >
            ...
            >
              ...
              >
                <div style={{ fontSize: 14, fontWeight: 700 }}>
                  {t('Расходы по месяцам', 'Monthly spend')}
                </div>
                    ...
                    >
                      <div
                        style={{
                          fontSize: 11,
                          fontFamily: mono,
                          color: current ? SUB0.blue : SUB0.muted,
                        }}
                      >
                        {fmtRub(v, { short: true })}
                      </div>
          ...
          >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                {cats.map(([name, v, c]) => (
                  ...
                  >
                    ...
                    <span style={{ fontFamily: mono, color: SUB0.muted }}>
            ...
            >
              ...
              >
                <div style={{ fontSize: 14, fontWeight: 700 }}>
                  {t('Календарь списаний', 'Renewal calendar')}
                </div>
                <div style={{ fontSize: 12, color: SUB0.muted, fontFamily: mono }}>
                  {t('Май 2026', 'May 2026')}
                </div>

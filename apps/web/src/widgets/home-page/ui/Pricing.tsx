      ...
      >
        <div>
          ...
          <H2>
            ...
            <span style={{ color: SUB0.blue }}>
              {t('выбери подходящий тариф.', 'pick the right plan.')}
            </span>
          </H2>
        </div>
        <a
          ...
          >
            ...
            <div>
              ...
              <div style={{ marginTop: 10, display: 'flex', alignItems: 'baseline', gap: 6 }}>
                ...
                <span
                  style={{ fontSize: 13, color: p.accent ? '#999' : SUB0.muted, fontFamily: mono }}
                >
                  {p.cadence}
                </span>
              </div>
              <div style={{ fontSize: 14, color: p.accent ? '#cfcfc6' : '#555', marginTop: 6 }}>
                {p.sub}
              </div>
            </div>

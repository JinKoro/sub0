...
export function FAQ() {
  ...
  const qs = [
    ...
    {
      q: t('Чем вы отличаетесь от заметки в телефоне или таблицы в Excel?', 'How is it different from a note or Excel spreadsheet?'),
      a: t(
    ...
    {
      q: t('Можно ли добавлять не подписки а ежемесячные траты?', 'Can I add non-subscription monthly expenses?'),
      a: t(
    ...
    {
      q: t('Безопасно ли хранить у вас данные о подписках?', 'Is it safe to store subscription data with you?'),
      a: t(
    ...
    {
      q: t('Что будет с моими подписками, если я не продлю Pro?', "What happens to my subscriptions if I don't renew Pro?"),
      a: t(
    ...
    },
    {
      ...
      a: t(
        ...
        'Via SBP or a Russian bank card.'
      ),
    },
    {
      ...
      <div style={{
        ...
        <div style={{ position: isMobile ? 'static' : 'sticky', top: 96 }}>
          ...
          <p style={{ fontSize: 15, color: SUB0.muted, marginTop: 20, lineHeight: 1.6 }}>
            ...
            <a href="mailto:support@sub0.app" className="s-a" style={{ color: SUB0.blue, textDecoration: 'none', fontWeight: 500 }}>
              support@sub0.app
            </a>
              ...
              <div key={i} style={{ borderBottom: `1px solid ${SUB0.line}` }}>
                <button
                  ...
                  style={{
                    ...
                    fontSize: isMobile ? 15 : 18, fontWeight: 600, letterSpacing: '-0.01em',
                    color: SUB0.ink, fontFamily: 'inherit',
                  }}
                >
                  <span style={{ fontFamily: mono, fontSize: 12, color: SUB0.muted, width: 32, flexShrink: 0 }}>

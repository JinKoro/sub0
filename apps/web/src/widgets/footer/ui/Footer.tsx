...
export function Footer() {
  ...
  return (
    <footer style={{
      background: SUB0.bg, color: SUB0.ink,
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{
          ...
          gap: isMobile ? 24 : 32, marginBottom: 56,
        }}>
          <div>
          ...
          {cols.map(c => (
            <div key={c.title}>
              <div style={{
                fontFamily: mono, fontSize: 11, color: SUB0.muted,
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
                {c.items.map(([label, href], idx) => {
                  ...
                  return (
                    <li key={label}>
                      <a href={href} className="s-a" style={{
                        color: SUB0.ink, textDecoration: 'none', fontSize: 14,
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            <a href="mailto:support@sub0.app" className="s-a" style={{ color: SUB0.muted, textDecoration: 'none' }}>
